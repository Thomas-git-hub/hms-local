                    ...
                    <div class="row gap-1">
                        <div class="col-md">
                            <div class="card shadow-none bg-label-success">
                                <div class="card-header d-flex justify-content-end">
                                    <small class="card-title text-success d-flex align-items-center">
                                ...
                                <div class="card-body text-success">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-8">
                                            <h5 class="card-title text-success">For Acknowledgement</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md">
                            <div class="card shadow-none bg-label-warning">
                                <div class="card-header d-flex justify-content-end">
                                    <small class="card-title text-success d-flex align-items-center">
                                        <span class="badge text-bg-warning">Yesterday</span>
                                    </small>
                                </div>
                                <div class="card-body text-warning">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-8">
                                            <h5 class="card-title text-warning">Pending as of Yesterday</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md">
                            <div class="card shadow-none bg-label-danger">
                                <div class="card-header d-flex justify-content-end">
                                    <small class="card-title text-success d-flex align-items-center">
                                        <span class="badge text-bg-danger">Several Days</span>
                                    </small>
                                </div>
                                <div class="card-body text-danger">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-10">
                                            <h5 class="card-title text-danger">Pending from the Past Several Days</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
