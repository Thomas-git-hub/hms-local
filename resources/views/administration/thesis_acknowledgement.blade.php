                    ...
                    <div class="row gap-1">
                            ...
                            <div class="card shadow-none bg-label-success">
                                ...
                                <div class="card-body text-success">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-8">
                                            <h5 class="card-title text-success">For Acknowledgements Today</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md">
                            <div class="card shadow-none bg-label-warning">
                                <div class="card-header d-flex justify-content-end">
                                    <small class="card-title text-warning d-flex align-items-center gap-1">
                            ...
                            <div class="card shadow-none bg-label-danger">
                                <div class="card-header d-flex justify-content-end">
                                    <small class="card-title text-danger d-flex align-items-center gap-1">
                                        <span class="badge bg-danger">Several Days</span>
                                    </small>
                                </div>
